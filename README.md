...
- `SHOW_GIRA_WELCOME_GIFT`: the welcome-gift campaign is shown by default. Set this to `false` to hide the announcement immediately (for example, until Smile.io is configured to grant it).
